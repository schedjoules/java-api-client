...
/**
 * An {@link AccessToken} that's derived from a {@link String}.
 *
 * @author Marten Gajda
 */
public final class StringAccessToken implements AccessToken
{
    ...
    public StringAccessToken(StringToken delegate)
    {
        mDelegate = delegate;
    }
